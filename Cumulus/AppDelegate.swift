...
class AppDelegate: NSObject, NSApplicationDelegate {
	...
	var applicationFilesDirectory: NSURL {
	    // Returns the directory the application uses to store the Core Data store file. This code uses a directory named "be.gillesdemey.Cumulus" in the user's Application Support directory.
	    let fileManager = NSFileManager.defaultManager()
	    let urls = fileManager.URLsForDirectory(.ApplicationSupportDirectory, inDomains: .UserDomainMask)
	    let appSupportURL: AnyObject = urls[urls.endIndex - 1]
	    return appSupportURL.URLByAppendingPathComponent("be.gillesdemey.Cumulus")
	}
	...
	var managedObjectModel: NSManagedObjectModel {
	    ...
	    let modelURL = NSBundle.mainBundle().URLForResource("Cumulus", withExtension: "momd")
	...
	var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
	    ...
	    let url = applicationFilesDirectory.URLByAppendingPathComponent("Cumulus.storedata")
